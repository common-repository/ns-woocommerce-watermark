...
?>
<div class="nsbigboxtheme<?php echo esc_attr($ns_style); ?>">
	<div class="titlensbigbox<?php echo esc_attr($ns_style); ?>">
		<h4><?php _e('JOIN NS CLUB', $ns_text_domain); ?></h4>
	</div>
	<div class="contentnsbigbox">
		<a href="<?php echo esc_url($link_promo_theme); ?>"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>img/ns_banner_membership-500.png" class="imgnsbigbox"></a>
		...
		<a href="<?php echo esc_url($link_promo_theme); ?>" class="linkBigBoxNS" target="_blank">
